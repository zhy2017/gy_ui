...
MySliderBar::MySliderBar(QWidget *parent) :	QWidget(parent)
{
...
void MySliderBar::resizeEvent(QResizeEvent *)
{
    int index = 0;
...
void MySliderBar::mousePressEvent(QMouseEvent *e)
{
    moveTo(e->pos());
}

void MySliderBar::keyPressEvent(QKeyEvent *keyEvent)
{
    if (!keyMove) {
        return;
    }
...
void MySliderBar::paintEvent(QPaintEvent *)
{
    //绘制准备工作,启用反锯齿
...
void MySliderBar::drawBg(QPainter *painter)
{
    painter->save();
...
void MySliderBar::drawBar(QPainter *painter)
{
    painter->save();
...
void MySliderBar::drawText(QPainter *painter)
{
    painter->save();
...
int MySliderBar::initStep(int distance)
{
    int n = 1;
...
QColor MySliderBar::getBgColorStart() const
{
    return this->bgColorStart;
}

QColor MySliderBar::getBgColorEnd() const
{
    return this->bgColorEnd;
}

QColor MySliderBar::getBarColorStart() const
{
    return this->barColorStart;
}

QColor MySliderBar::getBarColorEnd() const
{
    return this->barColorEnd;
}

QColor MySliderBar::getTextNormalColor() const
{
    return this->textNormalColor;
}

QColor MySliderBar::getTextSelectColor() const
{
    return this->textSelectColor;
}

QString MySliderBar::getItems() const
{
    return this->items;
}

int MySliderBar::getCurrentIndex() const
{
    return this->currentIndex;
}

QString MySliderBar::getCurrentItem() const
{
    return this->currentItem;
}

int MySliderBar::getBgRadius() const
{
    return this->bgRadius;
}

int MySliderBar::getBarRadius() const
{
    return this->barRadius;
}

int MySliderBar::getSpace() const
{
    return this->space;
}

int MySliderBar::getLineWidth() const
{
    return this->lineWidth;
}

QColor MySliderBar::getLineColor() const
{
    return this->lineColor;
}

MySliderBar::BarStyle MySliderBar::getBarStyle() const
{
    return this->barStyle;
}

bool MySliderBar::getKeyMove() const
{
    return this->keyMove;
}

bool MySliderBar::getHorizontal() const
{
    return this->horizontal;
}

bool MySliderBar::getFlat() const
{
    return this->flat;
}
...
QSize MySliderBar::minimumSizeHint() const
{
    return QSize(30, 30);
}

void MySliderBar::clearItem()
{
    listItem.clear();
    update();
}

void MySliderBar::setBgColorStart(const QColor &bgColorStart)
{
...
void MySliderBar::setBgColorEnd(const QColor &bgColorEnd)
{
...
void MySliderBar::setBarColorStart(const QColor &barColorStart)
{
...
void MySliderBar::setBarColorEnd(const QColor &barColorEnd)
{
...
void MySliderBar::setTextNormalColor(const QColor &textNormalColor)
{
...
void MySliderBar::setTextSelectColor(const QColor &textSelectColor)
{
...
void MySliderBar::setItems(const QString &items)
{
    this->items = items;
    this->listItem.clear();
...
void MySliderBar::setCurrentIndex(int index)
{
    moveTo(index);
}

void MySliderBar::setCurrentItem(const QString &item)
{
    moveTo(item);
}

void MySliderBar::setBgRadius(int bgRadius)
{
...
void MySliderBar::setBarRadius(int barRadius)
{
...
void MySliderBar::setSpace(int space)
{
    if (this->space != space) {
        this->space = space;
        update();
...
void MySliderBar::setLineWidth(int lineWidth)
{
...
void MySliderBar::setLineColor(const QColor &lineColor)
{
...
void MySliderBar::setBarStyle(MySliderBar::BarStyle barStyle)
{
...
void MySliderBar::setKeyMove(bool keyMove)
{
...
void MySliderBar::setHorizontal(bool horizontal)
{
...
void MySliderBar::setFlat(bool flat)
{
    if (this->flat != flat) {
...
void MySliderBar::moveTo(int index)
{
...
void MySliderBar::moveTo(const QString &item)
{
    int count = listItem.count();
...
void MySliderBar::moveTo(const QPointF &point)
{
    int count = listItem.count();
